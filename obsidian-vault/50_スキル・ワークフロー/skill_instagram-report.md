---
title: "Instagram Analytics Report (official Graph API)"
aliases:
  - "Instagram Analytics Report (official Graph API)"
category: "スキル・ワークフロー"
project: "Instagramレポート スキル"
created: 2026-07-08
source_repo: eiken0216/claude
source_branch: claude/instagram-follower-scraper-ar7xxk
source_path: ".claude/skills/instagram-report/SKILL.md"
tags:
  - ai-reference
  - スキル-ワークフロー
  - スキル
